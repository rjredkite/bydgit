			...
			<div class="row">
				<div class="col-md-12">
					<div class="page-listing-header">
						...
						<?php echo form_open('', array( 'method' => 'get', 'id' => 'form-stud-dogs' )); ?>
				...
				<div class="page-listing-body-container">
					<div class="page-listing-body">
						<div class="row">
							...
							<?php if($this->pages_model->count_stud_dogs($country_code, $breed_info['id'],$latitude2,$longitude2) == ''){

								echo 'No entries found';

							}elseif($this->pages_model->count_stud_dogs($country_code, $breed_info['id'],$latitude2,$longitude2) <= 25){ 

								echo 'Displaying all '.$this->pages_model->count_stud_dogs($country_code, $breed_info['id'],$latitude2,$longitude2);
								if($this->pages_model->count_stud_dogs($country_code, $breed_info['id'],$latitude2,$longitude2) == 1){
									echo ' listing';
								}else{
									echo ' listings';
								}
								...
								?> of <?php echo $this->pages_model->count_stud_dogs($country_code, $breed_info['id'],$latitude2,$longitude2); ?> in total</p>
							<?php } ?>
							</div>
							<div class="col-sm-6">
								<div class="text-right">
									<select id="sort-stud-dogs" name="sort_by">
							...
							<div class="col-sm-12">
								<?php foreach($studdogs as $stud): ?>
									<div class="listing-container<?php
										...
										}elseif($stud['featured'] == 1 && $stud['featured_until'] >= $datenow){
						            ...
						            ?>"> 
						            	...
						            	<?php if($userinfo['plan_id'] == 1 || $userinfo['plan_id'] == 5){ ?>
											...
											<?php
												}elseif($stud['highlight'] == 1 && $stud['highlight_until'] >= $datenow){
											?>
										...
										<?php }else{ ?>
											...
											<?php
												if($stud['featured'] == 1 && $stud['featured_until'] >= $datenow){
											?>

												<img src="<?php echo base_url('assets/img/featured-highlighted.png'); ?>" class="listing-all-banner" alt="Featured and Highlighted Listing Banner">                

											<?php  
												}elseif($stud['highlight'] == 1){
											?>
									  ...
									  <div class="row"> 
									    <div class="col-sm-11"> 
									      <h3><a <?php
					                        ...
					                        if($stud['listing_type'] == 'dog'){
					                          echo 'stud-dogs';
					                        }elseif($stud['listing_type'] == 'pup'){
					                          echo 'puppies';
					                        }elseif($stud['listing_type'] == 'mem'){
					                          echo 'memorials';
					                        }

					                        $slug_title = url_title($stud['title'], 'dash', TRUE);

					                        echo '/'.$stud['id'].'/'.$slug_title;
										      ...
										      <div class="row">
										        ...
										        <div class="col-xs-7">
										       		<?php
														...
														$latitude1 = $stud['latitude'];
														$longitude1 = $stud['longitude'];

														if($this->input->get('post_code', TRUE) != '' || $info['post_code'] != ''){

															echo $stud['region'].' '.(int)miles_distance($latitude1,$longitude1,$latitude2,$longitude2,$miles = true). ' Miles from you';
										      ...
										      <div class="row">
											   	...
											   	<div class="row">
											        ...
											        <div class="col-xs-8">
											          <?php 
							                            ...
							                            $date2 =  new DateTime($stud['date_of_birth']);
												...
												<div class="row">
										      	...
										      	<p class="listing-description">
										       		<?php echo word_limiter($stud['description'], 25); ?>
										      	</p>
												<div class="listing-bottons">
													<?php if($this->session->userdata('userlogged_in') && $users_id_session == $stud['user_id']): ?>
													<a <?php
														if($country_lang == 'us'){
								                          echo 'href="'.base_url('us/listings/'.$stud['id'].'/edit').'"';
								                        }else{
								                          echo 'href="'.base_url('listings/'.$stud['id'].'/edit').'"';
								                        }
							                        ?> type="button" class="btn btn-default"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
													<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#listing-modal-<?php echo $stud['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> Delete</button>
													<?php endif; ?>
													<a <?php
													if($country_lang == 'us'){
							                          echo 'href="'.base_url('us/');
									  ...
									  <div class="row">
									    <div class="col-xs-6">
									      <?php if($stud['listing_type'] == 'dog' && $this->session->userdata('userlogged_in') && $users_id_session == $stud['user_id']): ?>
					                       		<a type="button" class="btn btn-default" data-toggle="modal" data-target="#memorialise-modal-<?php echo $stud['id']; ?>">Memorialise</a>
					                      <?php endif; ?>
									    </div>
									    <div class="col-xs-6">
									...
									<div class="modal fade" id="listing-modal-<?php echo $stud['id']; ?>" role="dialog">
						                <div class="modal-dialog">
						                  <div class="modal-content">
						                    ...
						                    <?php echo form_open('/users/listing_delete/'.$stud['id']); ?>
						              ...
						              <?php echo form_open('/users/listing_memorial/'.$stud['id']); ?>
						                <div class="modal fade" id="memorialise-modal-<?php echo $stud['id']; ?>" role="dialog">
						                  <div class="modal-dialog">
						                    <div class="modal-content">
						                      <div class="modal-header">
						                        <button type="button" class="close" data-dismiss="modal">&times;</button>
