			...
			<div class="row">
				<div class="col-md-12">
					<div class="page-listing-header">
						...
						<?php echo form_open('listings', array( 'method' => 'get', 'id' => 'form-listings' )); ?>
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="text-right">
									<select id="sort-listings" name="sort_by">
							...
							<div class="col-sm-12">
								<?php foreach($listings as $listing): ?>
						            ...
						            ?>"> 
									    ...
									    <div class="col-sm-4">
									    	<?php 
					                      	...
					                      	<?php if($listing_image['image'] != ''): ?>
					                        	<img class="lazyload" src="<?php echo base_url('/uploads/listing_images/'.$listing_image['listing_id'].'/'.$listing_image['id'].'/thumb_'.$listing_image['image']); ?>" data-src="<?php echo base_url('/uploads/listing_images/'.$listing_image['listing_id'].'/'.$listing_image['id'].'/thumb_'.$listing_image['image']); ?>" alt="<?php echo $listing['title']; ?> Listing Image">
					                      	<?php else: ?>
									      ...
									      <div class="listing-contents">
										      <div class="row">
												...
												<div class="listing-bottons">
													<?php if($this->session->userdata('userlogged_in') && $users_id_session == $listing['user_id']): ?>
													<a <?php 
								                        if($country_lang == 'us'){
									  ...
									  <div class="row">
									    <div class="col-xs-6">
									      <?php if($listing['listing_type'] == 'dog' && $this->session->userdata('userlogged_in') && $users_id_session == $listing['user_id']): ?>
