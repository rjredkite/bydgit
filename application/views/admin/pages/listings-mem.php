	...
	<div class="search-container">
		...
		<div class="admin-search-fields">
			...
			<?php echo form_open('',array( 'method' => 'get')); ?>
				<div class="row">
					...
					<div class="col-md-6">
						<select name="listing_type">
							...
							<option value="mem" selected>Memorials</option>
						</select>
						<select name="gender">
				...
				<a href="<?php echo base_url('admin/listings/memorials'); ?>" class="btn button-cancel">Cancel</a>
			<?php echo form_close(); ?>
		</div>
	</div>
</div>
...
<div class="body-container">
	<div class="table-max">
		<p>
			<?php echo $this->admin_model->count_listings_mem(); ?> <?php 
				if($this->admin_model->count_listings_mem() <= 1){
					echo 'Listing Found';
				}else{
					echo 'Listings Found';
				}
